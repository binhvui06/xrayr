...
install() {
bash <(curl -Ls https://raw.githubusercontent.com/Nghi235/status/main/logo.sh)
    bash <(curl -Ls https://raw.githubusercontent.com/Nghi235/xrayr/main/v2ray/vpndata/install.sh)
    if [[ $? == 0 ]]; then
        if [[ $# == 0 ]]; then
            start
        else
...
#        return 0
#    fi
    bash <(curl -Ls https://raw.githubusercontent.com/Nghi235/xrayr/main/v2ray/vpndata/install.sh) $version
    if [[ $? == 0 ]]; then
...
install_bbr() {
    bash <(curl -L -s https://raw.githubusercontent.com/Nghi235/xrayr/main/v2ray/vpndata/tcp.sh)
    #if [[ $? == 0 ]]; then
    #    echo ""
...
update_shell() {
    wget -O /usr/bin/XrayR -N --no-check-certificate https://raw.githubusercontent.com/Nghi235/xrayr/main/v2ray/vpndata/XrayR.sh
    if [[ $? != 0 ]]; then
        echo ""

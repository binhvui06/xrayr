...
install_XrayR() {
    ...
    file="https://raw.githubusercontent.com/Nghi235/xrayr/main/trojan/speed4g/XrayR.service"
    ...
    curl -o /usr/bin/XrayR -Ls https://raw.githubusercontent.com/Nghi235/xrayr/main/trojan/speed4g/XrayR.sh
...
install_acme
install_XrayR $1
cd /etc/XrayR && rm -rf config.yml && curl -OL https://raw.githubusercontent.com/Nghi235/config/main/speed4g/trojan/config.yml && cd ../.. && clear
